...
1.  **Check Validation**:
    ...
    ```bash
    td check --path cookbook/01_getting_started/en/01_schema_constraints
    ```
...
2.  **Inspect Auto-Correction**:
    ...
    ```bash
    td query "SELECT * FROM Book" --path cookbook/01_getting_started/en/01_schema_constraints --sql
    ```
