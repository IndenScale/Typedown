    ...
    features: [
      {
        ...
        description: (
          <>
            ...
            <span className="text-success">{features.schema.desc_highlight}</span>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <span className="text-success">{features.logic.desc_highlight}</span>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <span className="text-success">{features.feedback.desc_highlight}</span>
...
entity King: mordred
  ...
  const getConflictDiagnostics = (code: string) => {
    ...
    const startLineIndex = lines.findIndex((line) => line.includes('entity King: mordred'))

    if (startLineIndex === -1) return []

    // Find the end of the block (simple heuristic: look for next empty line or end of string)
    let endLineIndex = startLineIndex
    while (endLineIndex + 1 < lines.length && lines[endLineIndex + 1].trim() !== '') {
      endLineIndex++
    }
  ...
  return (
    <div className="flex min-h-screen flex-col items-center selection:bg-success selection:text-black">
      ...
      <main className="flex w-full max-w-7xl flex-col items-center px-6 pt-20 pb-32 text-center sm:pt-32">
        <h1 className="text-5xl font-bold tracking-tight sm:text-7xl">{content.title}</h1>
        ...
        <div className="mt-32 w-full max-w-4xl border-t border-black/10 dark:border-white/10 pt-24">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">{content.aiTitle}</h2>
          <p className="mt-6 text-lg text-gray-400 leading-relaxed">{content.aiDesc}</p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">{content.aiStep1Desc}</p>
                  <a
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">{content.aiStep2Desc}</p>
