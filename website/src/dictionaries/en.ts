...
export const en: Dictionary = {
  ...
  home: {
    hero: {
      ...
      title_end: '.',
      description_start: 'Build trusted knowledge bases with Markdown, Pydantic, and Pytest.',
      description_highlight: '',
      description_end: 'The rigor of code meets the fluidity of natural language.',
    ...
    ai: {
      ...
      step1: {
        ...
        desc_post: ' directory in your project root, and download skill.md into it.',
      },
      ...
      prompt: 'Read the content in ./skills to understand how to interact with Typedown files.',
    },
  },
  playground: {
    header: {
