...
export function LandingCodeEditor({
  ...
  useEffect(() => {
    if (editorRef.current && monaco && markers.length > 0) {
      monaco.editor.setModelMarkers(editorRef.current.getModel(), 'typedown', markers)
    }
  }, [monaco, markers])
  ...
  return (
    ...
    >
      ...
      {/* Editor Content */}
      <div style={{ height: finalHeight }} className="transition-[height] duration-200 ease-out">
        <Editor
          height="100%"
